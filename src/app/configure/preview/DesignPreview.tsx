...
const DesignPreview = ({ configuration }: DesignPreviewProps) => {
    ...
    const { mutate: createPaymentSession, isPending } = useMutation({
        ...
        onError: () => {
            toast({
                ...
                description: "There was an error our end. Please try again.",
                variant: "destructive"
            });
        }
    })
    ...
    return (
        <>
            ...
            <div className='mt-20 md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12 flex flex-col items-center'>
