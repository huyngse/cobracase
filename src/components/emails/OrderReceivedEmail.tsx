...
const OrderReceivedEmail = ({
    ...
    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://cobracase-5oop.vercel.app"
    return (
        <Html>
            <Head />
            <Preview >
                ...
                <Container style={container}>
                    <Section style={message}>
                        ...
                        <Text style={global.text}>
                            We're preparing everything for delivery and will notify you once your package has been shipped. Delievery usually takes 2 days.
                        </Text>
                    ...
                    <Section style={paddingY}>
                        <Row>
                            <Text style={{
                                ...
                                Please contact us you have any questions. (If you reply to this email, we won't be able to see it.)
                            </Text>
                        </Row>
                        <Row>
